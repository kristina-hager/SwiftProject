...
At this point, the application has formed, or reformed, the WiFi Direct group and is ready to transfer data using socket objects and methods. Figure 2 shows the complete call flow for the Android WiFi Direct API peer to peer manager calls, listeners, and intents.
