...
Since the cave offers no larger rooms nor longer passages, we had to cease our experiments in this cave there.
However, we suspect that in a larger cave longer range should be possible based on the work of Moore, et al \cite{moore2012}.
