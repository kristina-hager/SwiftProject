...
\begin{abstract}
	...
	Typically, these researchers must retrieve data from these data loggers by entering the cave and travelling to the installation site.
	Travel in caves is slow, inconvenient, and often dangerous.
	We propose a a more efficient, safe, and automatic means of data retrieval which is to automatically ferry data back to the surface using WiFi Direct enabled devices. 
	...
	% kh, skip: Further work is required to fully implement an end to end solution including the data logger interface, methods to deal with harsh environments, and improved timing and synchronization for the automatic transfers. 
\end{abstract}
