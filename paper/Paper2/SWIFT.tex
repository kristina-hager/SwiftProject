...
Some caves consist of tiny passages too small for even humans and other caves consist of large booming passages and interior spaces that would accommodate even large buildings.
...
However, one major drawback of wire based systems is that the wire must be laid along the cave passage. 
...
The authors were using the system to essentially send text messages and did not address the data capacity of the system \cite{cavelink}.
...
TODO: Moore paper on autonomous mobile radios \cite{moore2012}
