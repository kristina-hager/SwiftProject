...
In addition to range, the current, and still nascent implementation of the WiFi Direct APIs may be somewhat limited for this use case.
One concern is that communication beyond a single WiFi Direct group may be a challenge, and this will be a key need for this application. 
