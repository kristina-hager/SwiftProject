...
% todo: Listeners notify which part of the app? I think Listeners are notified by xx of the success or failure
% i propose to avoid 'you' in this case since the notification isn't really to a person
% but to another part of the app
Listeners allow you to be notified of the success or failure of WifiP2pManager method calls. 
% todo: here , trying to avoid the 'you' and instead identify the parts of the app
% Intents notify which component or are notified by which component?
...
% todo: check that it's clear how/why/what receives notification
...
% todo: in some parts of this section, i'm tempted to specify which part of the app does what
% and/or include a diagram of how a basic WifiP2P app is structured w.r.t. components
% that said, I'd only mess with this if I have spare time, as I think the paper is solid as is
...
% todo: passive voice - would be cool to specify what component invokes the onConnectionInfoAvail
% The xx component is informed of a successful conection, or WiFi Direct group formation, when the ..
...
% KH - it's much easier to harden smaller devices to the elements if only because the enclosures are less expensive :)
% i.e. a small device could just be put in a small nalgene
% it's also much easier to place small devices in a cave where they'd be out of the way
% that said, this could be left out
