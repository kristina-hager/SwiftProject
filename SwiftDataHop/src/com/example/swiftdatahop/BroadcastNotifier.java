...
public class BroadcastNotifier {
     ...
     */
    public void broadcastIntentWithMessage(String msg) {

    	//\todo - KH probably want to change this to take a string logData instead of int status
     ...
     // Puts log data into the Intent
        localIntent.putExtra(Constants.EXTENDED_STATUS_LOG, msg);
